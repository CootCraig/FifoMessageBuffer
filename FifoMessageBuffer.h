...
short class FifoMessageBuffer {
  private:
    static const short defaultBufSize = 127;
  public:
    ...
    short available(); // Number of character slots available.
    ...
    short find(char aChar); // return the position of the character, -1 if not found.
    short length();
  ...
  private:
    ...
    void initForBuffer(char * bufPtr, short bufSize);
    char * insertPtr();
};
